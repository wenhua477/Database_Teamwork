...
<body class="mr-2 ml-2">
	...
	<form action="login" method="post">
		...
		<div class="form-group form-inline">
			...
			<input class = "form-control" id="username" name="username" value="${fn:escapeXml(param.firstname)}">
		</div>
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="password">Password</label>
			<input class = "form-control" id="password" name="password" type="password" value="${fn:escapeXml(param.password)}">
		</div>
