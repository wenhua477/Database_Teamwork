...
<body class="mr-2 ml-2">
	...
	<form action="usercreate" method="post">
		...
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="email">Email</label>
			<input class = "form-control" id="email" name="email" value="">
		</div>
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="phone">Phone</label>
			<input class = "form-control" id="phone" name="phone" value="">
		</div>
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="street">Street</label>
			<input class = "form-control" id="street" name="street" value="">
		</div>
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="city">City</label>
			<input class = "form-control" id="city" name="city" value="">
		</div>
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="state">State</label>
			<input class = "form-control" id="state" name="state" value="">
		</div>
		<div class="form-group form-inline">
			<label class="text-secondary col-1" for="zip">Zip</label>
